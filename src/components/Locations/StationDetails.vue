<template lang="html">
    <div id="station-details" v-if="location">
...
export default {
    ...
    computed: {
        ...
        filteredUpdateLocationTypes () { return this.location_types.filter( t => t.toLowerCase() === "outpost")},
        comResources() {
    ...
    methods: {
        ...
        addResource ( modal ) {
            ...
            const valid = this.mixinsValidate( this.meta_data.validation_rules.location.resources, resource, 'resources')
            if( valid ) {
